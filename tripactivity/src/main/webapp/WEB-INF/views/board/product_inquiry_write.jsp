...
<body>
<form id="Check_Join" name="Inquiry_1" method="post" action="/board/product_inquiry_write">
<section>
<div class = "container">
	...
	<div class="section-title" data-aos="zoom-out">
          ...
          <p>1:1 문의하기</p>
			...
			<input type="hidden" id="board_kind" name="board_kind" value="C">
    			...
    			<button type = "button" class="btn-outline-secondary" onClick="location.href='/board/product_inquiry'">목록</button>
