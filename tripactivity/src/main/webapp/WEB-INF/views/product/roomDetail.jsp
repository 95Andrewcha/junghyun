	...
	<div class="yj_productEnroll_option"id="yj_room">
            ...
            <div class="yj_productEnroll_room">
                ...
                <table border="1" class="yj_dayTable">
                    ...
                    <tr>
                        <th>평일요금</th>
                        <td><input type="text" name="ac_n_sjunPrice" class="" id="" value="${roomDetail.ac_n_sjunPrice }" disabled></td>
                        <td><input type="text" name="ac_n_smaxPrice" class="" id="" value="${roomDetail.ac_n_smaxPrice }" disabled></td>
                        <td><input type="text" name="ac_n_sPrice" class="" id="" value="${roomDetail.ac_n_sPrice }" disabled></td>
                    </tr>
                    <tr>
                        <th>주말요금</th>
                        <td><input type="text" name="ac_h_sjunPrice" class="" id="" value="${roomDetail.ac_h_sjunPrice }" disabled></td>
                        <td><input type="text" name="ac_h_smaxPrice" class="" id="" value="${roomDetail.ac_h_smaxPrice }" disabled></td>
                        <td><input type="text" name="ac_h_sPrice" class="" id="" value="${roomDetail.ac_h_sPrice }" disabled></td>
                    </tr>
                    <tr>
                        <th>입실시간</th>
                        <td colspan="3"><input type="text" name="ac_s_startTime" class="" id="" value="${roomDetail.ac_s_startTime }" disabled></td>
                        <!-- <td><input type="text" name="" class="" id="" value=""></td>
                        <td><input type="text" name="" class="" id="" value=""></td> -->
                    </tr>
                    <tr>
                        <th>퇴실시간</th>
                        <td colspan="3"><input type="text" name="ac_s_endTime" class="" id="" value="${roomDetail.ac_s_endTime }" disabled></td>
                        <!-- <td><input type="text" name="" class="" id="" value=""></td>
                        <td><input type="text" name="" class="" id="" value=""></td> -->
                    </tr>
                </table>
                <table border="1" class="yj_daesilTable">
                    ...
                    <tr>
                        <th>평일요금</th>
                        <td><input type="text" name="ac_n_djunPrice" class="" id="" value="${roomDetail.ac_n_djunPrice }" disabled></td>
                        <td><input type="text" name="ac_n_dmaxPrice" class="" id="" value="${roomDetail.ac_n_dmaxPrice }" disabled></td>
                        <td><input type="text" name="ac_n_dPrice" class="" id="" value="${roomDetail.ac_n_dPrice }" disabled></td>
                    </tr>
                    <tr>
                        <th>주말요금</th>
                        <td><input type="text" name="ac_h_djunPrice" class="" id="" value="${roomDetail.ac_h_djunPrice }" disabled></td>
                        <td><input type="text" name="ac_h_dmaxPrice" class="" id="" value="${roomDetail.ac_h_dmaxPrice }" disabled></td>
                        <td><input type="text" name="ac_h_dPrice" class="" id="" value="${roomDetail.ac_h_dPrice }" disabled></td>
                    </tr>
                    <tr>
                        <th>마감시간</th>
                        <td colspan="3"><input type="text" name="ac_d_endTime" class="" id="" value="${roomDetail.ac_d_endTime }" disabled></td>
                        <!-- <td><input type="text" name="" class="" id="" value=""></td>
                        <td><input type="text" name="" class="" id="" value=""></td> -->
                    </tr>
                    <tr>
                        <th>이용시간</th>
                        <td colspan="3"><input type="text" name="ac_d_maxTime" class="" id="" value="${roomDetail.ac_d_maxTime }" disabled></td>
                        <!-- <td><input type="text" name="" class="" id="" value=""></td>
                        <td><input type="text" name="" class="" id="" value=""></td> -->
                    </tr>
                </table>
                <div class="yj_productEnroll_image">
                    ...
                    <input type="file" multiple="multiple" name="fileName" class="yj_roomImgAdd" id="yj_roomImg" disabled>
        ...
        <button class="yj_roomModifyButton" id="yj_allButton">수정 하기</button>
        <button class="yj_roomDeleteButton" id="yj_allButton">삭제 하기</button>
        <button class="yj_roomListButton" id="yj_allButton">목록 보기</button>
        
        <form action="/product/roomManage" method="get" id="moveForm">
...
/* 수정 페이지 이동 */
$(".yj_roomModifyButton").on("click", function(e){
	e.preventDefault();
	let addInput = '<input type="hidden" name="ac_roomNum" value="${roomDetail.ac_roomNum}">';
	$("#moveForm").append(addInput);
	$("#moveForm").attr("action", "/product/roomModify");
	$("#moveForm").submit();
});	
/* 목록 이동 버튼 */
$(".yj_roomListButton").on("click", function(e){
	e.preventDefault();
	$("#moveForm").submit();	
});
/* 삭제 버튼 */
$(".yj_roomDeleteButton").on("click", function(e){
	e.preventDefault();
	let moveForm = $("#moveForm");
	moveForm.find("input").remove();
	moveForm.append('<input type="hidden" name="ac_roomNum" value="${roomDetail.ac_roomNum}">');
	moveForm.attr("action", "/product/roomDelete");
