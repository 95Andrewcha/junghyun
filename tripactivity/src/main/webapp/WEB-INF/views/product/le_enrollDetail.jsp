        ...
        <section class="yj_productEnroll_section">
            <div class="yj_productEnroll">
                ...
                <ul>
                    <li style="width:30%;">
                        액티비티 종류 :
                        <select name="le_Kind" id="yj_enrollSelect" disabled>
                            <option value="">-----------------</option>
                    ...
                    <li style="width:30%;">
                        대표자 성함 : 
                        <input type="text" name="c_Name" class="" id="" value="${le_enrollDetail.c_Name }" size="4" disabled>
                    </li>
                </ul>
                <ul>
                    <li style="width:30%;">
                        업체명 :
                        <input type="text" name="company_Name" class="" id="" value="${le_enrollDetail.company_Name }" disabled>
                    </li>
                    <li style="width:30%;">
                        사업자 번호 :
                        <input type="text" name="company_Number" class="" id="" value="${le_enrollDetail.company_Number }" disabled>
                    </li>
                    <li style="width:30%;">
                        핸드폰 번호 :
                        <input type="text" name="le_Phone" class="" id="" value="${le_enrollDetail.le_Phone }" disabled>
                    </li>
                </ul>
                <ul>
                    ...
                    <li style="width:30%;">
                        업체 전화번호 :
                        <input type="text" name="le_Call" class="" id="" value="${le_enrollDetail.le_Call }" disabled>
                    </li>
                    <li style="width:60%;">
                        주소 :
                        <input type="text" name="le_Add" class="" id="" value="${le_enrollDetail.le_Add }" size="84" disabled>
                    </li>
                </ul>
                <ul>
                ...
                <ul>
                    <li class="yj_mainImgLi">
                        ...
                        <input type="file" multiple="multiple" name="fileName" class="yj_mainImgAdd" id="yj_mainImg" value="레저 메인이미지" disabled>
            ...
            <div class="yj_productEnroll_service">
                <ul>
                    ...
                    <li>
                        <label><input type="checkbox" name="le_Select" class="yj_check" value="당일사용" disabled>당일사용가능</label>
                    </li>
                    <li>
                        <label><input type="checkbox" name="le_Select" class="yj_check" value="전액환불" disabled>미사용 전액환불</label>
                    </li>
                </ul>
                <input type="hidden" id="yj_checkSelect" name="le_Select" value="${le_enrollDetail.le_Select }" disabled>
            </div>
            <div class="yj_productEnroll_image">
                상품설명 이미지 추가<span>*이미지는 최대 10개까지만 업로드 가능합니다.</span>
                <label for="yj_ticketImg">이미지 파일</label>
                <input type="file" multiple="multiple" name="fileName" class="" id="yj_ticketImg" value="객실 이미지" disabled>
            ...
            <div class="yj_productEnroll_info">
         	...
         	<button class="yj_le_productDeleteButton" id="yj_allButton">삭제 하기</button>
        	<button class="yj_le_productListButton" id="yj_allButton" onclick="">목록 보기</button>
    ...
    $(function(){
       ...
       /* 이미지 업로드 */
    	...
    	$(".yj_le_productModifyButton").on("click", function(e){
    		e.preventDefault();
    		let addInput = '<input type="hidden" name="le_ProductNum" value="${le_enrollDetail.le_ProductNum}">';
    		$("#moveForm").append(addInput);
    		$("#moveForm").attr("action", "/product/le_enrollModify");
    		$("#moveForm").submit();
    	});	
    	
    	/* 목록 이동 버튼 */
    	$(".yj_le_productListButton").on("click", function(e){
    		e.preventDefault();
    		$("#moveForm").submit();	
    	});
    	
    	/* 삭제 버튼 */
    	$(".yj_le_productDeleteButton").on("click", function(e){
    		e.preventDefault();
    		let moveForm = $("#moveForm");
    		moveForm.find("input").remove();
    		moveForm.append('<input type="hidden" name="le_ProductNum" value="${le_enrollDetail.le_ProductNum}">');
    		moveForm.attr("action", "/product/le_enrollDelete");
